...
//		MMLMOP prob = new MMLMOP(3, 256, -10,10);
		...
		double[] shiftValues = IO.readShiftValuesFromFile("MData/CEC2021/cec2021_shift/1.txt");
...
//		MMLMOP prob = new MMLMOP(3, 256, -10,10);
		...
		double[] shiftValues = IO.readShiftValuesFromFile("MData/CEC2021/cec2021_shift/2.txt");
		prob.setShiftValues(shiftValues);
