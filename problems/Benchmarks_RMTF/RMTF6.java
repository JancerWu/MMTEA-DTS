...
public class RMTF6 {
    ...
    public static ProblemSet getT1() throws IOException {
        ...
        Training_DNN prob = new Training_DNN(trainIn, trainLabel, testIn, testLabel, 10, 5);
    ...
    public static ProblemSet getT2() throws IOException {
        ...
        Training_DNN prob = new Training_DNN(trainIn, trainLabel, testIn, testLabel, 12, 6);
        prob.setLossType("MSE");
    ...
    public static ProblemSet getT3() throws IOException {
        ...
        Training_DNN prob = new Training_DNN(trainIn, trainLabel, testIn, testLabel, 14, 7);
        prob.setLossType("MSE");
